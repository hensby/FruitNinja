...
public class GamingState : State
{
    ...
    private ShowExitInGame showExitInGame;
    ...
    public override void enter()
    {
        ...
        showExitInGame = ShowExitInGame.Instance;
...
//                return true;
    ...
    {
        showExitInGame.ShowExitTip();
    }

    private void HideExit()
    {
        scoreControl.LastScoreTime = showExitInGame.HideExitTip();
    }
